...
echo "$($PSQL "SELECT name FROM teams FULL JOIN games ON teams.team_id = winner_id WHERE year = 2018 AND round = 'Final'")"
...
echo "$($PSQL "SELECT name FROM teams FULL JOIN games ON teams.team_id = games.opponent_id WHERE name LIKE 'Co%' GROUP BY name")"
